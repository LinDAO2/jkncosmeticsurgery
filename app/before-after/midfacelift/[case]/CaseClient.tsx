...
import type { MidfaceliftCase } from '@/lib/midfaceliftCases'

type LightboxState = { srcs: string[]; index: number } | null

export default function CaseClient({ data }: { data: MidfaceliftCase }) {
  ...
  return (
    <>
      ...
      <section className="case-detail-section">
        ...
        <a className="case-detail-back" href="/before-after?category=ponytail">← Before and After</a>

        <div className="case-detail-header">
          <span className="section-label">Patient Case</span>
          <h1 className="case-detail-title">Invisible Access Mid Facelift</h1>
        </div>
        ...
        <div className="case-detail-more">
          <a className="case-detail-more-link" href="/before-after?category=ponytail">VIEW ALL CASES  →</a>
        </div>
