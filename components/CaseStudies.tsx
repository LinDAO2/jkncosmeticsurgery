...
const FALLBACK_CASES = [
  ...
  { id: 'f3', category: '', filter: 'ponytail',       href: '/before-after/midfacelift/case-01',   title: 'Invisible Access Mid Facelift',   tags: ['Invisible Access Mid Facelift', 'Lip Lift', 'Upper Blepharoplasty', 'Lower Blepharoplasty'], img: '/ba/midfacelift/case-01-new/01.jpg' },
]
